...
def damage_quant_parser():
    ...
    parser.add_argument('-m', '--microns_per_pixel', help='3 multiplicative '
                        'factors by which pixel values can be transformed to '
                        'micron values in x, y, and z (default 1, 1, 1)', 
...
def mapper_parser():
    ...
    parser.add_argument('data', help='sequence of swc, segid map, x y z microns per '
                        'pixel values -- in that order; five values in each entry'
